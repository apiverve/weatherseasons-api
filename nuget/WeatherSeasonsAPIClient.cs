...
namespace APIVerve.API.WeatherSeasons
{
    ...
    /// <summary>
    /// Client for the WeatherSeasons API
    /// </summary>
    public class WeatherSeasonsAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/weatherseasons";
        ...
        {
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 1900, Max = 2100 } }
        };
        ...
        public WeatherSeasonsAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WeatherSeasonsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WeatherSeasonsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WeatherSeasonsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WeatherSeasonsQueryOptions options)
        {
        ...
        public ResponseObj Execute(WeatherSeasonsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WeatherSeasonsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WeatherSeasonsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WeatherSeasonsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WeatherSeasonsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WeatherSeasonsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WeatherSeasonsQueryOptions options)
        {
