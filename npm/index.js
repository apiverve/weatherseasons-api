...
class weatherseasonsWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/weatherseasons');
        }
        ...
        this.validationRules = {"year":{"type":"integer","required":false,"min":1900,"max":2100,"default":2025}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/weatherseasons`);
        }
    }
...
module.exports = weatherseasonsWrapper;
