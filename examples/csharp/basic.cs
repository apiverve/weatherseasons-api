...
{
    class WeatherSeasonsExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/weatherseasons";

        /// <summary>
        /// Make a GET request to the Weather Seasons API
        /// </summary>
        static async Task<JsonDocument> CallWeatherSeasonsAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;year&quot;] &#x3D; 2024 };
        ...
        {
            Console.WriteLine("📤 Calling Weather Seasons API...\n");

            var result = await CallWeatherSeasonsAPI();
