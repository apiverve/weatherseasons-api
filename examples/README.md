# Weather Seasons API - Examples

This folder contains example code for using the Weather Seasons API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/weatherseasons',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/weatherseasons");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/weatherseasons](https://docs.apiverve.com/ref/weatherseasons)
