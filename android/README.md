...
```gradle
dependencies {
    implementation 'com.github.apiverve:weatherseasons-api:1.1.12'
}
```
...
```java
import com.apiverve.weatherseasons.WeatherSeasonsAPIClient;
import com.apiverve.weatherseasons.APIResponse;
import com.apiverve.weatherseasons.APIException;

// Initialize the client
WeatherSeasonsAPIClient client = new WeatherSeasonsAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/weatherseasons](https://docs.apiverve.com/ref/weatherseasons)
...
- **Documentation:** [https://docs.apiverve.com/ref/weatherseasons](https://docs.apiverve.com/ref/weatherseasons)
- **Issues:** [GitHub Issues](https://github.com/apiverve/weatherseasons-api/issues)
