// Package weatherseasons provides a Go client for the Weather Seasons API.
//
// For more information, visit: https://apiverve.com/marketplace/weatherseasons?utm_source=go&utm_medium=readme
package weatherseasons
...
const (
	baseURL        = "https://api.apiverve.com/v1/weatherseasons"
	defaultTimeout = 30 * time.Second
)

// Client is the Weather Seasons API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Weather Seasons API client.
...
// Execute makes a request to the Weather Seasons API with typed parameters.
//
...
//   - year: integer - The year to get the dates of the solstice and equinox [min: 1900, max: 2100]
