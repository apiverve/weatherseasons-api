...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/weatherseasons',
        'Source': 'https://github.com/apiverve/weatherseasons-api',
        'Bug Tracker': 'https://github.com/apiverve/weatherseasons-api/issues'
    },
    classifiers=[
